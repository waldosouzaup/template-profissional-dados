...
const post: Content = {
  ...
  category: "Linux",
  trail_id: "7c1d3b5f-0e2a-4d63-9b68-1a7b3e0d2f22",
  trail_position: 8,
...
describe("Card de post do blog", () => {
  ...
  it("artigo fora de uma trilha aparece como Artigo", () => {
    render(<MemoryRouter><PostCard post={{ ...post, trail_id: null, trail_position: null }} /></MemoryRouter>);
