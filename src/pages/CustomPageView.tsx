    ...
    <div className="min-h-screen bg-[#0a0a0a] text-white selection:bg-white/20 pt-16">
      ...
      <div className="max-w-[800px] mx-auto px-8 sm:px-12 lg:px-20 pt-20 pb-40">
        <div className="mb-12 animate-[fadeInUp_0.5s_ease-out_both]">
          <Link to="/" className="inline-flex items-center text-xs font-bold tracking-widest uppercase text-white/40 hover:text-white transition-colors mb-8">
            <ChevronLeft className="w-4 h-4 mr-1" />
            Voltar
          </Link>
          <h1 className="text-4xl sm:text-5xl font-light tracking-tight text-white leading-tight mb-6">
            {page.title}
          </h1>
        </div>

        <div className="prose prose-invert prose-lg max-w-none prose-headings:font-light prose-headings:text-white prose-a:text-primary hover:prose-a:text-primary/80 prose-img:rounded-xl prose-img:border prose-img:border-white/10 animate-[fadeInUp_0.6s_ease-out_0.2s_both]">
